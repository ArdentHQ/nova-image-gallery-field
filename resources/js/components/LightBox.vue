<template>
    <div class="bg-black bg-opacity-50 fixed pin z-50 flex justify-center items-center" v-if="visible"  @click="hide">
        <div class="absolute right-0 top-0 text-white cursor-pointer text-4xl p-1 mr-3" @click.stop="hide">&times;</div>
        <div class="flex">
            ...
            <div class="lightbox-image" @click.stop="">
                <img :src="images[localIndex].url" class="rounded-xl w-auto h-auto">
            </div>
            <div class="cursor-pointer self-center px-8"
                @click.stop="next"
